...
import static com.googlesource.gerrit.plugins.websession.broker.BrokerBasedWebSessionCache.WEB_SESSION_BROKER_CACHE_NAME;
...
public class BrokerBasedWebSession extends CacheBasedWebSession {
  public static class Module extends CacheModule {
    ...
    protected void configure() {
      ...
      cache(WEB_SESSION_BROKER_CACHE_NAME, String.class, WebSessionManager.Val.class)
